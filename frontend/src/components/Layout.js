...
const menuItems = [
  ...
  { text: 'Concierge', icon: <ChatIcon />, path: '/ai' },
  { text: 'Listings', icon: <Flight />, path: '/listings' },
  { text: 'Users', icon: <People />, path: '/users' },
  { text: 'Billing', icon: <AttachMoney />, path: '/billing' },
  { text: 'Analytics', icon: <BarChart />, path: '/analytics' },
  { text: 'System Health', icon: <HealthAndSafety />, path: '/system' },
  { text: 'Trip Bundles', icon: <LocalOffer />, path: '/bundles' },
  { text: 'AI Chat', icon: <ChatIconMUI />, path: '/chat' },
];
