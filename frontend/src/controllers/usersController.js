  ...
  getAllUsers: async (req, res) => {
    try {
      ...
      const [users] = await mysqlPool.execute(
        `SELECT user_id, first_name, last_name, email, city, state, phone_number, created_at 
         FROM users 
      ...
      const [countResult] = await mysqlPool.execute('SELECT COUNT(*) as total FROM users');
